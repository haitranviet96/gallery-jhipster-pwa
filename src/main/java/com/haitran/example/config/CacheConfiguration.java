package com.haitran.example.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.haitran.example.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.haitran.example.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
