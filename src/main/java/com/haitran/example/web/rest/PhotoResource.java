...
import com.haitran.example.domain.Photo;
import com.haitran.example.repository.PhotoRepository;
import com.haitran.example.web.rest.errors.BadRequestAlertException;
import com.haitran.example.web.rest.util.HeaderUtil;
import com.haitran.example.web.rest.util.PaginationUtil;
...
public class PhotoResource {
    ...
    public ResponseEntity<List<Photo>> getAllPhotos(Pageable pageable,
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page,
                String.format("/api/photos?eagerload=%b", eagerload));
